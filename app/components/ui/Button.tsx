  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold font-display transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-gold-light hover:scale-105 active:scale-100 shadow-[0_0_60px_hsl(42_100%_50%_/_0.15)]",
        glass: "bg-[hsl(0_0%_100%_/_0.05)] backdrop-blur-xl border border-border/50 text-foreground hover:bg-[hsl(0_0%_100%_/_0.1)] hover:border-primary/30",
        teal: "bg-teal text-secondary-foreground hover:bg-teal-light hover:scale-105",
      },
      size: {
